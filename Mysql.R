...
db_user <- 'admin'
db_password <- 'sq1032624'
db_name <- 'testdb'
db_host <- 'sqltest.cx6gqmyy2qxk.us-east-1.rds.amazonaws.com'
db_port <- 3306
...
#Add a row
dbGetQuery(mydb, "INSERT INTO studentAssessment (id_assessment, id_student, date_submitted, is_banked, score) 
           VALUES ('00001', '1', '20', '0', '50');")
